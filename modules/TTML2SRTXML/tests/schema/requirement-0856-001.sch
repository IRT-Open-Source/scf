...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"  queryBinding="xslt" schemaVersion="ISO19757-3">
    <title>Testing text nodes mapping - line breaks (no lines)</title>
    <pattern id="text_mapping_line_breaks_none">
        <rule context="/">
        ...
        <rule context="SRTXML/subtitle[1]">
            <assert test="count(line) = 0">
                No line element must be present.
            </assert> 
        </rule>
    </pattern>
</schema>