...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"  queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing begin element mapping</title>
    <pattern id="begin_element_mapping">
        <rule context="/">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p">
            <assert test="@begin = '00:00:00.680'">
                Expected value: "00:00:00.680" Value from test: "<value-of select="@begin"/>"
            </assert> 
        </rule>
    </pattern>
</schema>