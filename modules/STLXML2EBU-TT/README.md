...
STLXML2EBU-TT.xslt has the following parameters:
    ...
    - timeCodeFormat  
     ...
     - JCspacetrimming  
        If set to 'false' spaces in the TF element which parent TTI element has a Justification code (JC) of '00' (unchanged presentation) are not normalized and preserved (default is True). 
