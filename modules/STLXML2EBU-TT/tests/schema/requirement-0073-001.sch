...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing DoubleHeight element mapping</title>
    <pattern id="FirstTimeStamps">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/tt:span">
            <assert test="substring-after(@style, ' ')=//tt:tt/tt:head/tt:styling/tt:style[@tts:fontSize='1c 2c']/@xml:id">
                Expected value: "1c 2c" Value from test: "<value-of select="@fontSize"/>"
            </assert> 
        </rule>
    </pattern>            
</schema>
