...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing BlackBackground with AlphaBlack</title>
    <pattern id="FirstTimeStamps">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/tt:span[2]">
            <assert test="@style = 'AlphaBlackOnAlphaBlack'">
                Expected value: "AlphaBlackOnAlphaBlack" Value from test: "<value-of select="@style"/>"
            </assert>
        </rule>
    </pattern>            
</schema>
