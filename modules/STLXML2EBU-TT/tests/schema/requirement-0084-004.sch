...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing NewForeground element with unchanging AlphaMagenta</title>
    <pattern id="FirstTimeStamps">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/tt:span">
            <assert test="@style = 'AlphaMagentaOnAlphaBlack'">
                Expected value: "AlphaMagentaOnAlphaBlack" Value from test: "<value-of select="@style"/>"
            </assert>
        </rule>
    </pattern>            
</schema>
