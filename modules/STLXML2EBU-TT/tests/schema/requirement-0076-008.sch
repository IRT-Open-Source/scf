...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing Control Codes mapping for AlphaCyan</title>
    <pattern id="CC_AlphaCyan">
        <rule context="/">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/tt:span[2]">
            <assert test="/tt:tt/tt:head/tt:styling/tt:style[
                ...
                Expected a referenced style with attribute tts:color='cyan'. Referenced styles: "<value-of select="@style"/>"
            </assert> 
        </rule>
    </pattern>            
</schema>
