...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing JC with value "01h"</title>
    <pattern id="JCspacetrimming">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p">
            <assert test="@style=//tt:tt/tt:head/tt:styling/tt:style[@tts:textAlign='start']/@xml:id">
                Expected value: "singleHeightLeft" Value from test: "<value-of select="@style"/>"
            </assert> 
        </rule>
