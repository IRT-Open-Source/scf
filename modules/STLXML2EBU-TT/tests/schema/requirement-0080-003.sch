...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing NewBackground element with unchanging AlphaRed</title>
    <pattern id="FirstTimeStamps">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/tt:span">
            <assert test="@style = 'AlphaWhiteOnAlphaRed'">
                Expected value: "AlphaWhiteOnAlphaRed" Value from test: "<value-of select="@style"/>"    
            </assert>
        </rule>
    </pattern>            
</schema>
