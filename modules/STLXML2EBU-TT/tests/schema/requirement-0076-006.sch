...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing Control Codes mapping for AlphaBlue</title>
    <pattern id="CC_AlphaBlue">
        <rule context="/">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/tt:span[2]">
            <assert test="/tt:tt/tt:head/tt:styling/tt:style[
                ...
                Expected a referenced style with attribute tts:color='blue'. Referenced styles: "<value-of select="@style"/>"
            </assert> 
        </rule>
    </pattern>            
</schema>
