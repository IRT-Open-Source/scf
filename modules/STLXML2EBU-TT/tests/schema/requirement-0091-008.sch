...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing NewBackground with AlphaYellow</title>
    <pattern id="FirstTimeStamps">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/tt:span[2]">
            <assert test="@style = 'AlphaBlackOnAlphaYellow'">
                Expected value: "AlphaBlackOnAlphaYellow" Value from test: "<value-of select="@style"/>"
            </assert>
        </rule>
    </pattern>            
</schema>
