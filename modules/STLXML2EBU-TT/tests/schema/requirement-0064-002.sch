...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing parameter JCspacetrimming without specifying it and JC set to "00h"</title>
    <pattern id="JCspacetrimming">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p">
            <assert test="@style=//tt:tt/tt:head/tt:styling/tt:style[@tts:textAlign='center']/@xml:id">
                Expected value: "singleHeightCenter" Value from test: "<value-of select="@style"/>"
            </assert> 
        </rule>
