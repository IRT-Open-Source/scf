...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing parameters "offsetInSeconds" and "offsetInFrames" at the same time</title>
    <pattern id="offsetInSecondsAndFrames">
        <rule context="/">
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]">
            <assert test="@begin = '00:00:01:00'">
                Expected value: 00:00:01:00. Value from test: <value-of select="@begin"/>
            </assert> 
            <assert test="@end = '00:00:04:00'">
                Expected value: 00:00:04:00. Value from test: <value-of select="@end"/>
            </assert> 
        </rule>
    </pattern>            
</schema>
