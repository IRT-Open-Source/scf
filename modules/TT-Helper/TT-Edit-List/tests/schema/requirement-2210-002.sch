...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing "Append edit list" with one edit (timebase media)</title>
    <pattern id="AppendEditListMedia">
        <rule context="/">
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[3]/@begin">
            <assert test=". = '00:01:35.280'">
                Expected value: "00:01:35.280" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
