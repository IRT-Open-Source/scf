...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing "Apply offset to timecodes" (timebase media)</title>
    <pattern id="ApplyOffsetToTimecodesMedia">
        <rule context="/">
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@begin">
            <assert test=". = '00:00:01.000'">
                Expected value: "00:00:01.000" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@end">
            <assert test=". = '00:00:03.200'">
                Expected value: "00:00:03.200" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[4]/@begin">
            <assert test=". = '00:01:50.360'">
                Expected value: "00:01:50.360" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[4]/@end">
            <assert test=". = '00:01:53.080'">
                Expected value: "00:01:53.080" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
    </pattern>
</schema>
