...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing "Adjust timecodes" (timebase media)</title>
    <pattern id="AdjustTimecodesMedia">
        <rule context="/">
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@begin">
            <assert test=". = '00:00:00.040'">
                Expected value: "00:00:00.040" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@end">
            <assert test=". = '00:00:02.240'">
                Expected value: "00:00:02.240" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[2]/@begin">
            <assert test=". = '00:00:14.600'">
                Expected value: "00:00:14.600" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[2]/@end">
            <assert test=". = '00:00:15.920'">
                Expected value: "00:00:15.920" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
    </pattern>
</schema>
