...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing "Append IN/OUT timecodes" with edit (timebase media; different timecode fractions)</title>
    <pattern id="AppendInOutTimecodesMedia">
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@begin">
            <assert test=". = '00:00:00.480'">
                Expected value: "00:00:00.480" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@end">
            <assert test=". = '00:00:03.800'">
                Expected value: "00:00:03.800" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[2]/@begin">
            <assert test=". = '00:00:25.280'">
                Expected value: "00:00:25.280" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[2]/@end">
            <assert test=". = '00:00:29.000'">
                Expected value: "00:00:29.000" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[3]/@begin">
            <assert test=". = '00:01:34.880'">
                Expected value: "00:01:34.880" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[3]/@end">
            <assert test=". = '00:01:37.480'">
                Expected value: "00:01:37.480" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
    </pattern>
</schema>
