...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing "Append IN/OUT timecodes" without actual edit (timebase smpte)</title>
    <pattern id="AppendInOutTimecodesSmpte">
        <rule context="/">
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@begin">
            <assert test=". = '00:00:01:01'">
                Expected value: "00:00:01:01" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@end">
            <assert test=". = '00:00:03:06'">
                Expected value: "00:00:03:06" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[4]/@begin">
            <assert test=". = '00:01:50:10'">
                Expected value: "00:01:50:10" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[4]/@end">
            <assert test=". = '00:01:53:03'">
                Expected value: "00:01:53:03" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
    </pattern>
</schema>
