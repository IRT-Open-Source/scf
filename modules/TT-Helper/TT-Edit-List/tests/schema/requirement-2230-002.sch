...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing "Apply offset to timecodes" (timebase smpte)</title>
    <pattern id="ApplyOffsetToTimecodesSmpte">
        <rule context="/">
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@begin">
            <assert test=". = '00:00:01:00'">
                Expected value: "00:00:01:00" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@end">
            <assert test=". = '00:00:03:05'">
                Expected value: "00:00:03:05" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[4]/@begin">
            <assert test=". = '00:01:50:09'">
                Expected value: "00:01:50:09" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[4]/@end">
            <assert test=". = '00:01:53:02'">
                Expected value: "00:01:53:02" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
    </pattern>
</schema>
