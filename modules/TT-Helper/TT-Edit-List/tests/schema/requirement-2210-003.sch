...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing "Append edit list" with two edits (timebase media)</title>
    <pattern id="AppendEditListMedia">
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[1]/@end">
            <assert test=". = '00:00:01.240'">
                Expected value: "00:00:01.240" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        ...
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[2]/@begin">
            <assert test=". = '00:00:08.600'">
                Expected value: "00:00:08.600" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div[1]/tt:p[2]/@end">
            <assert test=". = '00:00:11.920'">
                Expected value: "00:00:11.920" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
    </pattern>
</schema>
