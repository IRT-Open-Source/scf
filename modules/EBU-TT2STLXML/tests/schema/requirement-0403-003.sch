...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"  queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing Offset parameter with negative (= to be applied) 10:00:00:00</title>
    <pattern id="Offset">
        <rule context="/">
        ...
        <rule context="StlXml/BODY/TTICONTAINER/TTI[position() = 1]">
            <assert test="TCI = '10000210'">
                Expected value: "10000210" Value from test: "<value-of select="TCI"/>"
            </assert> 
            <assert test="TCO = '10000400'">
                Expected value: "10000400" Value from test: "<value-of select="TCO"/>"
            </assert> 
        </rule>
    </pattern>            
</schema>
