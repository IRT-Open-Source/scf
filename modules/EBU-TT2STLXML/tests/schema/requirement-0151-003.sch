...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"  queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing referenced tt:style elements by tt:span elements with changing foreground</title>
    <pattern id="StyleChangingBackground">
        ...
        <rule context="StlXml/BODY/TTICONTAINER/TTI[position() = 1]/TF">
            ...
            <assert test="name(child::*[name(.) != 'space'][5]) = 'EndBox'"> 
                Expected value at position 5 (space elements are ignored): "EndBox". Value from test: "<value-of select="name(child::*[name(.) != 'space'][5])"/>" 
            </assert>
        </rule>
    </pattern>            
</schema>
