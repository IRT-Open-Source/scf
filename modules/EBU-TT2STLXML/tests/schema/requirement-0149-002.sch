...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"  queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing doubleHeight Parameter with value "true"</title>
    <pattern id="DoubleheightLinebreak">
        ...
        <rule context="StlXml/BODY/TTICONTAINER/TTI[position() = 1]/TF">
            <assert test="count(newline)= 2"> 
                Expected number of newline elements: "2" Value from test: "<value-of select="count(newline)"/>" 
            </assert>
        </rule>
    </pattern>            
</schema>
