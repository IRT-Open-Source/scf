...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"  queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing tt:p element mapping with tt:metadata elements present</title>
    <pattern id="TNB">
        <rule context="/">
        ...
        <rule context="StlXml/BODY/TTICONTAINER/TTI[position() = 1]/TF">
            ...
            <assert test="count(child::text()) = 2">
                Expected number of text nodes: '2'. Value from test: "<value-of select="count(child::text())"/>"
            </assert>
        </rule>
    </pattern>            
</schema>
