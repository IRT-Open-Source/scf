...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"  queryBinding="xslt2" schemaVersion="ISO19757-3">
    ...
    <title>Testing TCI element with ttp:timeBase set to "media" and 25 frames upper bound</title>
    <pattern id="FirstTimeStamps">
        ...
        <rule context="StlXml/BODY/TTICONTAINER/TTI[position() = 1]">
            <assert test="TCI = '23595924'">
                Expected value: "23595924" Value from test: "<value-of select="TCI"/>"
            </assert> 
        </rule>
    </pattern>            
</schema>
