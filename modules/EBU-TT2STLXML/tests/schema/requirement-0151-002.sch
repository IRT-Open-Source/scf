...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"  queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing referenced tt:style elements by tt:span elements with changing background and foreground</title>
    <pattern id="StyleChangingBackground">
        ...
        <rule context="StlXml/BODY/TTICONTAINER/TTI[position() = 1]/TF">
            ...
            <assert test="name(child::*[name(.) != 'space'][3]) = 'AlphaGreen'"> 
                Expected value at position 3 (space elements are ignored): "AlphaGreen". Value from test: "<value-of select="name(child::*[name(.) != 'space'][3])"/>" 
            </assert>
            ...
            <assert test="name(child::*[name(.) != 'space'][5]) = 'AlphaRed'"> 
                Expected value at position 5 (space elements are ignored): "AlphaRed". Value from test: "<value-of select="name(child::*[name(.) != 'space'][5])"/>" 
            </assert>
