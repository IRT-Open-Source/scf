...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"  queryBinding="xslt2" schemaVersion="ISO19757-3">
    ...
    <title>Testing TCI element with ttp:timeBase set to "media" and 30 frames lower bound</title>
    <pattern id="FirstTimeStamps">
        ...
        <rule context="StlXml/BODY/TTICONTAINER/TTI[position() = 1]">
            <assert test="TCI = '00000000'">
                Expected value: "00000000" Value from test: "<value-of select="TCI"/>"
            </assert> 
        </rule>
    </pattern>            
</schema>
