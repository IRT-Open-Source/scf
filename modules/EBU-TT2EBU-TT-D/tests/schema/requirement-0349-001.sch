...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing the offsetInFrames parameter with value "10:00:00:00"</title>
    <pattern id="offsetInFrames">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/@end">
            <assert test=". = '00:00:02.400'">
                Expected value: "00:00:02.400" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
    </pattern>            
</schema>
