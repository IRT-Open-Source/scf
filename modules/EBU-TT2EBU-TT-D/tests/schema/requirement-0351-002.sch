...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing tts:color and tts:background with value AlphaBlue</title>
    <pattern id="SpanIDAttribute">
        ...
        <rule context="tt:tt/tt:head/tt:styling/tt:style[@xml:id = 'AlphaBlueOnAlphaWhite']">
            <assert test="@tts:backgroundColor = '#ffffffff'">
                Expected value: "#ffffffff" Value from test: "<value-of select="@tts:backgroundColor"/>"
            </assert> 
            <assert test="@tts:color = '#0000ffff'">
                Expected value: "#0000ffff" Value from test: "<value-of select="@tts:color"/>"
            </assert> 
        </rule>
        <rule context="tt:tt/tt:head/tt:styling/tt:style[@xml:id = 'AlphaWhiteOnAlphaBlue']">
            <assert test="@tts:backgroundColor = '#0000ffff'">
                Expected value: "#0000ffff" Value from test: "<value-of select="@tts:backgroundColor"/>"
            </assert> 
