...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing the offsetStartOfProgramme parameter with Start-of-Programme value "10:00:01:03"</title>
    <pattern id="offsetInFrames">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/@begin">
            <assert test=". = '00:00:00.880'">
                Expected value: "00:00:00.880" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div/tt:p/@end">
            <assert test=". = '00:00:02.680'">
                Expected value: "00:00:02.680" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
    </pattern>            
</schema>
