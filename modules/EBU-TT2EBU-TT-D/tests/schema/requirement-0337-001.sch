...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing the offsetInSeconds with value "36000" and ttp:timeBase set to 'media'</title>
    <pattern id="offsetInFrames">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/@end">
            <assert test=". = '00:00:02.100'">
                Expected value: "00:00:02.100" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
    </pattern>            
</schema>
