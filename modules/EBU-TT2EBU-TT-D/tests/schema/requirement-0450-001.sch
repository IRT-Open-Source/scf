...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing tts:extend attribute with percetange values</title>
    <pattern id="SpanIDAttribute">
        ...
        <rule context="tt:tt/tt:head/tt:layout/tt:region">
            <assert test="@tts:extent = '90% 90%'">
                Expected value: "90% 90%" Value from test: "<value-of select="@tts:extent"/>"
            </assert> 
        </rule>
    </pattern>            
</schema>
