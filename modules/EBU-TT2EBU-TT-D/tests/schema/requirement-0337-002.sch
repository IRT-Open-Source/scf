...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing the offsetInSeconds with value "36000" and ttp:timeBase set to 'smpte'</title>
    <pattern id="offsetInFrames">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p/@begin">
            <assert test=". = '00:00:02.000'">
                Expected value: "00:00:02.000" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
        <rule context="tt:tt/tt:body/tt:div/tt:p/@end">
            <assert test=". = '00:00:03.960'">
                Expected value: "00:00:03.960" Value from test: "<value-of select="."/>"
            </assert>
        </rule>
    </pattern>            
</schema>
