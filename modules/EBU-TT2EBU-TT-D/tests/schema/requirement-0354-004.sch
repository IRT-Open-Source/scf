...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <title>Testing tts:fontStyle attribute</title>
    <pattern id="SpanIDAttribute">
        ...
        <rule context="tt:tt/tt:head/tt:styling/tt:style[@xml:id = 'teststyle_normal']">
            <assert test="@tts:fontStyle = 'normal'">
                Expected value: "normal" Value from test: "<value-of select="@fontStyle"/>"
            </assert> 
        </rule>
        <rule context="tt:tt/tt:head/tt:styling/tt:style[@xml:id = 'teststyle_italic']">
            <assert test="@tts:fontStyle = 'italic'">
                Expected value: "italic" Value from test: "<value-of select="@fontStyle"/>"
            </assert> 
        </rule>
    </pattern>            
</schema>
