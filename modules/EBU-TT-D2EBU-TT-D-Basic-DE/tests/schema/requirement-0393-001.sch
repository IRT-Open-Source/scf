    ...
    <pattern id="FirstTimeStamps">
        ...
        <rule context="tt:tt/tt:body/tt:div/tt:p[position() = 1]">
            <assert test="@begin = '00:00:00.000'">
                Expected value for begin: "00:00:00.000" Value from test: "<value-of select="@begin"/>" 
            </assert> 
            <assert test="@end = '00:00:02.000'">
                Expected value for end: "00:00:02.000" Value from test: "<value-of select="@end"/>"
            </assert>
        </rule>
    </pattern>            
</schema>
