...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"  queryBinding="xslt" schemaVersion="ISO19757-3">
    ...
    <title>Testing begin and end attributes with ttp:timeBase set to "media" and ebuttm:authoredFrameRate set to "25" with more than 3 digits for milliseconds</title>
